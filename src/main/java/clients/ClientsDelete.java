...
@WebServlet(urlPatterns = "/clientsDelete")
public class ClientsDelete extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeUpdate ("DELETE FROM clients WHERE AuthenticationNumber =" + cAuthenticationNumber );

        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
        response.getWriter().append("<html><head>\n" +
                "</head><body> Clients delete!<p><a href=\"./\">Return back</a></p></body></html>");
    }
